...
(function(root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		define(['ApiClient', 'model/Money', 'model/SavingBasis', 'model/SavingsV2'], factory);
	} else if (typeof module === 'object' && module.exports) {
		// CommonJS-like environments that support module.exports, like Node.
		module.exports = factory(require('../ApiClient'), require('./Money'), require('./SavingBasis'), require('./SavingsV2'));
	} else {
		// Browser globals (root is window)
		if (!root.ProductAdvertisingAPIv1) {
			root.ProductAdvertisingAPIv1 = {};
		}
		root.ProductAdvertisingAPIv1.OfferPriceV2 = factory(root.ProductAdvertisingAPIv1.ApiClient, root.ProductAdvertisingAPIv1.Money, root.ProductAdvertisingAPIv1.SavingBasis, root.ProductAdvertisingAPIv1.SavingsV2);
	}
}(this, function(ApiClient, Money, SavingBasis, SavingsV2) {
	'use strict';
	...
	exports.constructFromObject = function(data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty('SavingBasis')) {
				obj['SavingBasis'] = SavingBasis.constructFromObject(data['SavingBasis']);
			}
			if (data.hasOwnProperty('Savings')) {
				obj['Savings'] = SavingsV2.constructFromObject(data['Savings']);
			}
		}
		return obj;
	}
	...
	/**
	 * @member {module:model/SavingBasis} SavingBasis
	 */
	exports.prototype['SavingBasis'] = undefined;
	/**
	 * @member {module:model/SavingsV2} Savings
	 */
