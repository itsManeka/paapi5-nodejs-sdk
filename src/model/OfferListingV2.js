...
(function(root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		define(['ApiClient', 'model/OfferAvailabilityV2', 'model/OfferConditionV2', 'model/DealDetails', 'model/OfferMerchantInfoV2', 'model/OfferPriceV2'], factory);
	} else if (typeof module === 'object' && module.exports) {
		// CommonJS-like environments that support module.exports, like Node.
		module.exports = factory(require('../ApiClient'), require('./OfferAvailabilityV2'), require('./OfferConditionV2'), require('./DealDetails'), require('./OfferMerchantInfoV2'), require('./OfferPriceV2'));
	} else {
...
}(this, function(ApiClient, OfferAvailabilityV2, OfferConditionV2, DealDetails, OfferMerchantInfoV2, OfferPriceV2) {
	'use strict';
